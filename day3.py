...
paths1 = [['R75','D30','R83','U83','L12','D49','R71','U7','L72'],['U62','R66','U55','R34','D71','R55','D58','R83']]
paths2 = [['R98','U47','R26','D63','R33','U87','L62','D20','R33','U53','R51'],['U98','R91','D20','R16','D67','R40','U7','R15','U6','R7']]
...
# collect all of the intersections
intersects = []
for loc, ps in grid.items():
    if loc != (0,0):
        ###
        pids  = [p[0] for p in ps]
        steps = [p[1] for p in ps]
        if len(set(pids)) > 1:
            #intersects.append(manhattan_distance((0,0), loc))
            intersects.append(sum(steps))
